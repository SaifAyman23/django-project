...
class CrispyFormView(UnfoldModelAdminViewMixin, FormView):
    ...
    permission_required = (
        "dashboard.view_driver",
        "dashboard.add_driver",
        "dashboard.change_driver",
        "dashboard.delete_driver",
    )
    template_name = "dashboard/driver_crispy_form.html"
...
class CrispyFormsetView(UnfoldModelAdminViewMixin, FormView):
    ...
    template_name = "dashboard/driver_crispy_formset.html"
