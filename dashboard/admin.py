...
from dashboard.resources import AnotherConstructorResource, ConstructorResource
from dashboard.views import CrispyFormsetView, CrispyFormView
...
class ConstructorAdmin(ModelAdmin, ImportExportModelAdmin, ExportActionModelAdmin):
    ...
    def custom_actions_row(self, request, object_id):
        ...
        return redirect(
            ...
            or reverse_lazy("admin:dashboard_constructor_changelist")
        )
...
class ChartSection(TemplateSection):
    template_name = "dashboard/driver_section.html"
...
class DriverAdminMixin(DjangoQLSearchMixin, ModelAdmin):
    ...
    list_before_template = "dashboard/driver_list_before.html"
    list_after_template = "dashboard/driver_list_after.html"
    change_form_show_cancel_button = True
    change_form_before_template = "dashboard/driver_change_form_before.html"
    change_form_after_template = "dashboard/driver_change_form_after.html"
    ...
    def display_header(self, instance: Driver) -> list:
        ...
        return [
            ...
            instance.initials,
            {
                "path": static("dashboard/images/avatar.jpg"),
                "height": 24,
                "width": 24,
                "borderless": True,
                # "squared": True,
...
class DriverAdmin(GuardedModelAdmin, SimpleHistoryAdmin, DriverAdminMixin):
    ...
    def changelist_action1(self, request):
        ...
        return redirect(reverse_lazy("admin:dashboard_driver_changelist"))
    ...
    def change_detail_action(self, request, object_id):
        ...
        if request.method == "POST" and form.is_valid():
            ...
            return redirect(
                reverse_lazy("admin:dashboard_driver_change", args=[object_id])
            )

        return render(
            request,
            "dashboard/driver_action.html",
            {
                "form": form,
                "object": object,
    ...
    def change_detail_action1(self, request, object_id):
        ...
        return redirect(reverse_lazy("admin:dashboard_driver_change", args=[object_id]))
...
class DriverActiveComponent(BaseComponent):
    def get_context_data(self, **kwargs):
        ...
        context["children"] = render_to_string(
            "dashboard/helpers/kpi_progress.html",
            {
